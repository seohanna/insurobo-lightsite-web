...
{/* <pre>              <h2>제1장 총칙</h2>
              <h3>제1조 (목적)</h3>
              <div class="in-txt">이 약관은 주식회사 인슈로보플러스 (이하" 회사"라 한다)가 운영하는 모바일기기를 통해 제공하는 모바일 서비스(이하 "서비스")를 이용함에 있어 서비스를 이용하는 이용자의 권리 · 의무 및 책임 사항을 규정함을 목적으로 합니다. 다만, 전자금융거래 이용에 관한 사항은 '전자금융거래 이용약관'의 내용을 따릅니다.</div>
              <h3>제2조 (용어의 정의)</h3>
              <ol class="ol-type numb">
                <li>이 약관에서 사용하는 용어의 의미는 다음과 같습니다.
                  <ul class="list-dot">
                    <li>단말기란 무선 인터넷서비스가 가능하고, 인슈로보플러스 모바일 서비스 앱을 설치할 수 있는 휴대용 전자기기를 말한다.</li>
                    <li>모바일 서비스란 이용자가 모바일 기기를 통해 이용할 수 있도록 인슈로보플러스에서 제공하는 보험 및 기타서비스를 의미합니다.</li>
                    <li>이용자란 모바일에서 인슈로보플러스 앱에 접속하여 이 약관에 따라 인슈로보플러스 모바일 서비스를 제공받는 고객을 의미합니다.</li>
              ...
              <ol class="ol-type numb">
                <li>회사는 본 약관의 내용을 이동 통신형 단말기(이하 '단말기')를 통하여 구현된 ‘인슈로보플러스’ 앱 서비스 화면에 게시하거나 기타의 방법으로 이용자가 알 수 있도록 알리고, 이에 동의한 이용자가 본 서비스에 가입하여 회원이 되었을 때 약관은 그 효력이 발생합니다.</li>
              ...
              <ol class="ol-type numb">
                ...
                <li>본 약관과 관련하여 회사의 정책 변경, 법령의 제·개정, 공공기관의 고시나 지침 등에 따라 회사가 ‘인슈로보플러스’ 앱 공지사항 게시판 등을 통해 공지하는 내용도 이용 계약의 일부를 구성합니다.</li>
              </ol>
              ...
              <ol class="ol-type numb">
                ...
                <li>기업회원은 법인명으로 기업회원으로 가입 신청을 하고 해당기업이 참여하기를 원하는 서비스를 신청하고 결제합니다.</li>
              ...
              <div class="in-txt">회사는 서비스의 게시물 또는 내용물이 회원이 회원의 의무에 위배되는 행위를 한 경우나 회사 소정의 게시기간을 초과하는 경우 및 게시판의 성격에 부합되지 않는 게시물인 경우 해당한다고 판단되는 경우 회원에게 사전통지나 동의 없이 이를 삭제할 수 있습니다.</div>
              <h2>제5장 기타</h2>
