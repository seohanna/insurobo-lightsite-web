  ...
  return (
    <>
      ...
      <OlList type='1' >
        ...
        <li>
          1.2 회사는 비회원 주문일 때에도 본인 인증 및 확인, 보험계약 조회/유지/관리, 보험금청구, 민원처리 및 분쟁대응에 필요한 개인정보만을 요청합니다. 이때 해당 정보는 대금결제 및 상품의 배송과 관련된 용도로 사용되며 그 밖의 용도로는 절대 사용되지 않습니다. 비회원으로 서비스를 이용할 때에는 회원에게만 적용되는 사항을 제외한 나머지 부분에 대해서는 회원과 동일하게 개인정보처리방침이 적용됩니다.(개인정보 보유 및 이용기간 등)
          <Table className="table_01">
            <tr>
              <th>구분</th>
              <th>수집항목</th>
        ...
        <li>
          1.3 서비스 이용 과정에서 아래와 같은 정보들이 자동으로 생성되어 수집될 수 있습니다.
          <ul className="dep2">
      ...
      <ListTitle>2.개인정보 보유 및 이용 기간</ListTitle>
      <OlList type="2">
        ...
        <li>2.2 불법 행위 방지를 위한 보유
          <div className="dep2">반복적인 회원 탈퇴와 재가입으로 경제적 이익 취득 등 불법적인 행위를 차단하기 위해 문제시되는 개인정보(회원 ID등)는 회원 탈퇴 후 1년간 보유할 수 있다.</div>
        </li>
      </OlList>
      <ListTitle>3.개인정보 파기 절차 및 방법</ListTitle>
      <InnerText>회사는 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체없이 파기하며 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제하며 문서 등 종이에 출력된 개인정보는 분쇄기로 파기합니다. 단, 관계 법령에 의한 사유에 해당하는 경우 일정기간 저장된 후 파기됩니다.</InnerText>
      <ListTitle>4.개인정보의 제3자 제공</ListTitle>
      <InnerText>필수적으로 필요한 경우 주의를 기울여 아래 대상자에게 개인정보를 제공합니다.</InnerText>
      <OlList>
        <li>4.1 서비스 사용자
          <div className="type-in">회사의 서비스 사용 중 고객의 금융 소비내역 및 고객이 선택적으로 입력한 기타정보가 연결된 회원 간에 공개될 수 있습니다. 또한 고객이 상대방을 초대하거나 친구로 등록하는 경우, 설정에 따라 초대자 혹은 친구 식별을 위해 이름, 프로필 사진 일부 소비내역 정보가 피초대자에게 공개될 수 있습니다.</div>
        </li>
        <li>4.2 제휴사(영업회원)
        ...
        <li>4.3 회사는 서비스 제공을 위해 회원의 동의를 얻는 등 적극적이고 적법한 절차를 토하여 아래와 같이 개인정보를 제공할 수 있습니다.
          <Table className="table_02">
            ...
            <tr>
              <th>제공 항목</th>
              <td>이름, 생년월일, 성별, 휴대폰번호, 내외국인구분, 중복가입확인정보, 본인확인정보, 보험계약정보, 보험사고정보(사고일, 경위 등)</td>
            </tr>
            <tr>
              <th>보유 기간</th>
              <td>제공 동의 철회 전까지</td>
          ...
          <Table className="table_03">
            ...
            <tr>
              <td>어센틱금융그룹㈜,인카금융서비스㈜, 메트라이프금융서비스㈜, ㈜신한금융플러스, ㈜에이플러스에셋어드바이저보험대리점, 배달서비스공제조합</td>
      ...
      <ListTitle>5. 고객 및 법정대리인의 권리와 행사 방법</ListTitle>
      <OlList>
        <li>5.1 개인정보의 열람 및 수정 요청
          <div className="type-in">고객 및 법정대리인은 언제든지 등록되어 있는 본인의 개인정보를 조회, 수정할 수 있습니다. 이용자는 개인정보의 조회, 수정을 위하여 서비스에 등록된 정보를 클릭하거나 설정 메뉴에 접근하여 계정 정보 등 등록된 개인정보를 직접 열람하거나 수정할 수 있습니다.</div>
        </li>
        <li>5.2 개인정보의 삭제(회원탈퇴)
          <div className="type-in">고객이 회원탈퇴를 원하는 경우 개인정보관리담당자에게 서면 또는 이메일로 연락하시면 지체없이 조치를 취하겠습니다.</div>
        </li>
      </OlList>
      <ListTitle>6. 개인정보보호를 위한 기술 및 관리적 대책</ListTitle>
      <OlList type='2'>
        <li>6.1 기술적 대책
          <div class="type-in">해킹 등의 외부침입에 대비하여 각 서버마다 침입차단시스템 등을 이용하여 보안에 만전을 기하고 있습니다. 이용자의 개인정보는 비밀번호에 의해 보호되며 중요한 데이터는 암호화 알고리즘에 의해 보호되고 있습니다.</div>
        </li>
        <li>6.2 관리적 대책
          <ul className="dep2">
            <li>6.2.1 개인 정보 접근 권한을 최소한의 인원으로 제한
              <div class="type-in">회사는 개인정보관련 취급 직원을 담당자에 한정시키고 있으며 개인 정보에 접근을 위한 별도의 비밀번호를 부여하여 정기적으로 갱신하고 있습니다.</div>
            </li>
            <li>6.2.2 개인정보 관리 관련 내부 교육 강화<div class="type-in">회사는 내부 직원에 대한 수시 교육을 통하여 회사의 개인정보취급방침의 준수를 항상 강조하고 있습니다. 또한 신규직원 채용시 정보보호서약서에 서명하게 함으로써 직원에 의한 정보유출을 사전에 방지하고 개인정보 취급방침에 대한 이행사항 및 직원 준수여부를 감시하기 위해 내부 절차를 마련하여 지속적으로 시행하고 있습니다.</div></li>
            <li>6.2.3 개인정보보호전담기구의 운영<div class="type-in">회사는 사내 개인정보보호전담기구 등을 통하여 회사의 개인정보취급방침의 이행사항 및 담당자의 준수여부를 확인하여 문제가 발견될 경우 즉시 수정하고 바로잡을 수 있도록 노력하고 있습니다.</div></li>
          </ul>
        </li>
      </OlList>
      <ListTitle>7. 고객의 권리와 의무</ListTitle>
      <InnerText>회사는 타인의 이메일 주소, Facebook 등 제휴업체 ID 또는 기타 개인정보를 도용하여 회원가입 한 자 또는 서비스를 이용한 자를 발견한 경우 지체없이 해당 아이디에 대한 서비스 이용 정지 또는 회원탈퇴 등 필요한 조치를 취합니다.</InnerText>
      <ListTitle>8. 개인정보관리책임자 및 담당자 안내</ListTitle>
      <UlTypeList>
        <li>회사는 고객의 개인정보 관련 문의사항 및 불만 처리 등을 위하여 아래와 같이 개인정보 관리 책임자 및 담당자를 지정하고 있습니다.
          <Table className="table_04">
            <tr>
              <th></th>
              <th>개인정보보호담당자</th>
              <th>개인정보보호책임자</th>
        ...
        <li>개인정보 침해에 대한 피해구제 또는 상담이 필요한 이용자께서는 아래 기관에 문의하여 주시기바랍니다.
          <Table className="table_05">
            ...
            <tr>
              ...
              <td>(국번없이)<br />118</td>
              <td><a href="https://privacy.kisa.or.kr" class="sc-ehVsHJ jGAknK">https://privacy.kisa.or.kr</a></td>
            </tr>
            <tr>
              <td>개인정보분쟁조정위원회</td>
              <td>1833-6972</td>
              <td><a href="https://www.kopico.go.kr" class="sc-ehVsHJ jGAknK">https://www.kopico.go.kr</a></td>
            </tr>
            <tr>
              <td>대검찰청<br />사이버수사과</td>
              <td>(국번없이)<br />1301</td>
              <td><a href="http://www.spo.go.kr" class="sc-ehVsHJ jGAknK">http://www.spo.go.kr</a></td>
            </tr>
            <tr>
              <td>경찰청<br />사이버안전국</td>
              <td>(국번없이)<br />182</td>
              <td><a href="http://cyberbureau.police.go.kr" class="sc-ehVsHJ jGAknK">http://cyberbureau.police.go.kr</a></td>
            </tr>
          </Table>
        </li>
      </UlTypeList>              
      <InnerText>본 개인정보취급방침의 내용 추가, 삭제 및 수정이 있을 경우 개정 최소 7일 전에 서비스 내 '공지사항'을 통해 사전 고지할 것입니다. 개인정보의 수집 및 활용, 제3자 제공 등과 같이 고객 권리의 중요한 변경이 있을 경우에는 최소 30일 전에 고지합니다.</InnerText>
      <InnerText>현 개인정보처리방침은 2023년 12월 01일부터 적용됩니다.
